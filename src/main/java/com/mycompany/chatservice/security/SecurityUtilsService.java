...
import com.mycompany.chatservice.domain.Response;
import com.mycompany.chatservice.domain.Error;;

public final class SecurityUtilsService {
	private static final ObjectMapper mapper = new ObjectMapper();

	private SecurityUtilsService() {
	}
