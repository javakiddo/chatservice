chatApp.service('Session', function () {
...
chatApp.service('AuthSharedService', function ($rootScope, $http, $resource, authService, Session) {
    return {
...
chatApp.service('HomeService', function ($log, $resource) {
    return {
        getTechno: function () {
...
chatApp.service('UsersService', function ($log, $resource) {
    return {
        getAll: function () {
...
chatApp.service('TokensService', function ($log, $resource) {
    return {
        getAll: function () {
