...
angular.module('webChat.controllers', ['toaster'])
    .controller('ChatContoller', ['$scope', '$location', '$interval', 'toaster', 'ChatSocket', function ($scope, $location, $interval, toaster, chatSocket) {
